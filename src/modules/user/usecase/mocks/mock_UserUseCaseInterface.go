...
// Source: github.com/cde/go-example/src/modules/user/usecase (interfaces: UserUseCaseInterface)
...
func (m *MockUserUseCaseInterface) CreateUser(arg0 context.Context, arg1 *dto.UserRequest) (*dto.UserResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserUseCaseInterface) GetUser(arg0 context.Context, arg1 int32) (*dto.UserResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserUseCaseInterface) ListUsers(arg0 context.Context, arg1, arg2 int) ([]dto.UserResponse, error) {
	m.ctrl.T.Helper()
